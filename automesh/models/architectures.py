...
#         self.down_convs.append(conv_layer(in_channels, channels, **conv_layer_kwargs))
#         for i in range(depth):
#             self.pools.append(pool_layer(channels, **pool_kwargs) ) # self.pool_ratios[i]**pooling_kwargs
#             self.down_convs.append(conv_layer(channels, channels, **conv_layer_kwargs))

#         in_channels = channels if sum_res else 2 * channels

#         self.up_convs = nn.ModuleList()
#         for i in range(depth - 1):
#             self.up_convs.append(conv_layer(in_channels, channels, **conv_layer_kwargs))
#         self.up_convs.append(conv_layer(in_channels, out_channels, **conv_layer_kwargs))
